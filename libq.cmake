...
if(USE_GETTEXT)
	...
	if(NOT GETTEXT_FOUND)
		message(FATAL_ERROR "\n${RED}sudo apt-get install gettext${NONE}\n")
	endif()
endif()
...
if(USE_OPENSSL)
	...
	if(NOT OPENSSL_FOUND)
		message(FATAL_ERROR "\n${RED}sudo apt-get install libssl-dev${NONE}\n")
	endif()
endif()
...
if(USE_CURL)
	find_package(CURL)
	if(NOT CURL_FOUND)
		message(FATAL_ERROR "\n${RED}sudo apt-get install libcurl4-openssl-dev${NONE}\n")
	endif()
endif()
...
#	if(NOT MYSQL_FOUND)
	...
	if(HAVE_MYSQL_H)
		set(MYSQL_LIBRARIES mariadbclient mariadbclient_r)
	else()
		message(FATAL_ERROR "\n${RED}Install development files for MySQL or MariaDB.${NONE}\n")
	endif()
endif()
...
if(USE_POSTGRESQL)
	...
	if(POSTGRESQL_FOUND)
		...
		message(FATAL_ERROR "\n${RED}sudo apt-get install libpq-dev${NONE}\n")
	endif()
endif()
